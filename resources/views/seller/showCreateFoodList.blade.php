                ...
                <div class="row mb-5">
                    <div class="col-lg-6 mb-2">
                        <div class="form-group">
                            <label class="text-label">نام غذا *</label>
                            <input type="text" onkeyup="foodNameValidation(this)" name="foodName"
                                class="form-control" placeholder="نام غذا را وارد کنید ...." required>
                            <div id="foodNameValidationMessage" class="invalid-feedback">
                                ...
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 mb-2">
                        <div class="form-group">
                            <label class="text-label">مواد اولیه *</label>
                            <input type="text" onkeyup="ingredientsFoodValidation(this)" name="ingredientsFood"
                                class="form-control" placeholder="مواد اولیه غذا را وارد کنید . . ." required>
                            <div id="ingredientsFoodValidationMessage" class="invalid-feedback">
                                ....
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 mb-2">
                        <div class="form-group">
                            <label class="text-label"> قیمت *</label>
                            <input type="text" name="foodPrice" class="form-control"
                                onkeyup="foodPriceValidation(this)" id="inputGroupPrepend2"
                                aria-describedby="inputGroupPrepend2" placeholder="33000" required>
                            <div id="foodPriceValidationMessage" class="invalid-feedback">
                                ....
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 mb-2">
                        <div class="form-group">
                            ...
                            <div>
                                ...
                                <!-- Modal -->
                                <div id="uploadImageValidationMessage" class="invalid-feedback">
                                    ....
                                </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">بارگذاری تصاویر</h5>
                                            ...
                                            <div class="modal-body">
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text"
                                                        onclick="document.getElementById('vorodiyeDaryafteAskShenaseh').click()">بارگذاری</span>
                                                    <div class="form-file">
                                                        <input type="file" id="vorodiyeDaryafteAskShenaseh" onchange="uploadImageValidation(this)"
                    ...
                    <div class="col-lg-6 mb-2">
                        <div class="form-group">
                            <label class="form-label">نوع دسته بندی غذا *</label>
                            {{-- // TODO وقتی که چندین دسته انتخاب کرد برنامه چه کار کند  --}}
                            <select onchange="categoryNewFoodValidation(this)" name="typeOfFood" multiple class="default-select  form-control wide">
                    ...
                    <div class="col-lg-12 mb-3">
                        <button id="personlalEnformationSaveButton" onclick="saveNewFood(this)"
