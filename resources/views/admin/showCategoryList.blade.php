...
<body>
                                    ...
                                    <tbody>
                                        @foreach ($categories as $key => $category)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-sm-8">
                                                        <input id="editCategoryInputId-{{ $category->id }}"
                                                            data-gs-input-id={{ $category->id }}
                                                            onblur="editCategoryInputOnblur(this)" disabled type="text"
                                                            value="{{ $category->name }}" class="form-control"
                                                            placeholder="">
                                                    </div>

                                                </td>
                                                <td>{{ $category->group == 'food' ? 'غذا' : 'رستوران' }}</td>
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="javascript:void()" data-gs-id="{{ $category->id }}"
                                                            onclick="editCategoryOnClick(this)"
                                                            id="editCategoryOnClick-{{ $category->id }}"
    ...
    ***********************************-->
    ...
    <script src="{{ asset('js/admin/dashboard/category/editCategory.js') }}"></script>
