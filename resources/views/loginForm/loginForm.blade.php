                                ...
                                <div class="auth-form">
                                    ...
                                    <form action="index.html">
                                        <div class="form-group">
                                            <label class="mb-1"><strong>پست الکترونیک</strong></label>
                                            <input type="email" class="form-control" value="demo@koki.com">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-row d-flex justify-content-between mt-4 mb-2">
                                            <div class="form-group">
                                                <div class="form-check custom-checkbox ms-1">
													...
													<label class="custom-control-label" for="basic_checkbox_1">اطلاعات من یادت باشه </label>
												</div>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="new-account mt-3">
                                        <p>حساب کاربری نداری ؟ مشکلی نداره از  <a class="text-primary" href="page-register.html"> اینجا </a>میتونی ثبت نام کنی .</p>
                                    </div>
                                </div>
                            </div>
                        </div>
