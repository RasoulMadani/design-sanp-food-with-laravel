...
function showOrderDetails(event) {
    let id = event.dataset.gsOrderId;
    let restaurantId = event.dataset.gsRestaurantId;
    ...
    xhr.open(
        "GET",
        `/seller/dashboard/orders/${id}?restaurantId=${restaurantId}`
    );
        ...
        if (response.allah == "perform") {
            ...
            <div class="form-head d-flex mb-3 mb-md-5 align-items-start flex-wrap">
					<div class="me-auto">
						...
						<svg class="me-3" width="24" height="12" viewBox="0 0 24 12" fill="none" xmlns="http://www.w3.org/2000/svg" style="transform: rotatey(180deg);">
						...
						بازگشت</a>
						<h3 class="text-black font-w600 mb-0 fs-22 mb-2">شناسه سفارش : <span dir="ltr">#555100</span></h3>
						<a class="mb-0 text-black font-w500" href="#">سفارشات  /</a>
						<a class="mb-0 font-w500" href="#">جزئیات سفارش </a>
					</div>
								...
								<div class="card">
									<div class="card-body">
										<div class="full-map-area">
											<img src="images/svg/map.svg" alt="" style="width:100%;"> 
									...
									<div class="card-body rounded" style="background:#3f4953;">
										<div class="row mx-0 align-items-center">
											<div class="media align-items-center col-md-12 col-xl-6 col-lg-4 px-0 mb-3 mb-md-0">
												<img class="me-3 img-fluid rounded-circle" width="100" src="images/profile/5.png" alt="عکس">
												<div class="media-body">
													<p class="text-white mb-1 wspace-no">مسئول تحویل سفارش</p>
													<h3 class="mb-1 text-white  fs-22">هادی شریفی</h3>
													<small class="text-gray wspace-no">کد شناسایی : 412455</small>
												</div>
											</div>
											<div class="text-start text-lg-right col-xl-6 col-lg-8 p-0 mt-lg-0 mt-3">
												<div class="iconbox">
													...
													<small>تلفن</small>
													<p><span dir="ltr">+98 912 566 6654</span></p>
												</div>
												<div class="iconbox">
									...
									<div class="card-body p-0">
										<div class="table-responsive order-list">
											<table class="table items-table">
												<tbody><tr>
													<th class="my-0 text-black font-w500 fs-20">سفارشات</th>
													<th style="width:10%;" class="my-0 text-black font-w500 fs-20">تعداد</th>
													<th style="width:17%;" class="my-0 text-black font-w500 fs-20">قیمت واحد</th>
															...
															<tr class="cartItem" data-gs-id-cart-item="${payam.idCartItem}">
																<td>
																	<div class="media">
																		...
																		<div class="media-body">
																			<small class="mt-0 mb-1 font-w500"><a class="text-primary" href="javascript:void(0);">غذای اصلی</a></small>
																			<h5 class="mt-0 mb-2 mb-4"><a class="text-black" href="ecom-product-detail.html">${payam.nameGhaza}</a></h5>
																			<div class="star-review fs-14">
																				...
																				<i class="fas fa-star text-gray"></i>
																				<span class="ms-3 text-dark">(454 دیدگاه)</span>
																			</div>
																		</div>
																	</div>
																</td>
																<td>
																	<h4 class="my-0 text-secondary font-w600">${payam.quantity}x</h4>
																</td>
																<td>
																	<h4 class="my-0 text-secondary font-w600">${payam.unitPrice}<small>تومان</small></h4>
																</td>
																<td class="d-md-none d-lg-table-cell">
																	<h4 class="my-0 text-secondary font-w600">${totalPrice} <small>تومان</small></h4>
																</td>
																<td>
						...
						<div class="row">
							<div class="col-xl-12 col-md-6 col-xxl-6">
								<div class="card">
									...
									<div class="card-body">
										<h4 class="text-black font-weight-bold mb-3 wspace-no">یادداشت سفارش</h4>
										<p>لطفا همراه با پیتزا سس و ادویه هم بذارین</p>
									</div>
								</div>
							</div>
							<div class="col-xl-12 col-md-6 col-xxl-6">
								<div class="card">
									<div class="card-header border-0">
										<h4 class="text-black font-w600 wspace-no">علاقه مندی های مشتری</h4>
									</div>
									<div class="card-body pt-0">
										...
										<div class="mb-3">
											<div class="d-flex justify-content-between mb-3">
												<p class="mb-0 fs-14 text-black">پیتزا (40%)</p>
										...
										<div class="mb-3">
											<div class="d-flex justify-content-between mb-3">
												<p class="mb-0 fs-14 text-black">پاستا (35%)</p>
										...
										<div class="mb-3">
											<div class="d-flex justify-content-between mb-3">
												<p class="mb-0 fs-14 text-black">دسر (25%)</p>
